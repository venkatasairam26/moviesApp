...
class Header extends Component {
  ...
  render() {
    const {inputBox, homeRoute, popularRoute} = this.props
    const {menu} = this.state
    const inputStyle = inputBox ? 'input-card' : 'non-search'
    const HomeTextStyle = homeRoute ? 'Home-text-active' : ''
    const PopularTextStyle = popularRoute ? 'Home-text-active' : ''
          ...
          <div className="logo-ul-cont">
            ...
            <ul className="ul-link">
              <Link to="/" className="route-link">
                <li className={`home-route-text ${HomeTextStyle}`}>Home</li>
              </Link>
              <Link to="/popular" className="route-link">
                <li className={`nav-text ${PopularTextStyle}`}>Popular</li>
              </Link>
            </ul>
          </div>
